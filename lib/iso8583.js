...
var ISO8583 = function(packagerName) {
  /* tamami
  console.log("--- tamami ---");
  console.log("PackagerName : "  + packagerName);
  console.log("--- end ---");*/
  ...
  if (packagerName == 'smartVista') {
    ...
    /* tamami
    console.log("--- tamami ---");
    console.log("Isi formatnya : "  + packagerName);
    console.log("--- end ---"); */
  } else {
    // asli
  ...
  this._pack = function(row, id) {
    ...
    try {
      ...
      */
      ...
      console.log("bahan row: " + util.inspect(row));
      result = require('./packer/' + packager.type).pack(row, packager);
      console.log("Hasil _pack id:" + id + " -> " + util.inspect(result));
    } catch(e) {
  ...
  this.unpack = function(msg) {
    ...
    //tamami
    console.log("Isi datanya: " + result.data);
    //--end tamami
  ...
  this.pack = function(data) {
    ...
    var result;
    //tamami
    console.log("data dari method pack: " + util.inspect(data));
    //---end tamami
    data = this._sort(data);
    console.log("Datanya: " + util.inspect(data));
    for(var i in data) {
      if (i == 1) {
